...
%   \begin{subfigure}[b]{0.2\textwidth}
%     \centering
%     \includegraphics[options]{images/q3_eigenface_res1.png}
%   \end{subfigure}
%   \hspace{2em}
%   \begin{subfigure}[b]{0.2\textwidth}
%     \centering
%     \includegraphics[options]{images/q3_eigenface_res2.png}
%   \end{subfigure}
%   \hspace{2em}
%   \begin{subfigure}[b]{0.2\textwidth}
%     \centering
%     \includegraphics[options]{images/q3_eigenface_res3.png}
%   \end{subfigure}
